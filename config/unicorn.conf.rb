worker_processes 2
working_directory '/data/app/ahgoblin/current'
listen '/data/app/ahgoblin/shared/sockets/unicorn.sock', :backlog => 64
timeout 30
pid '/data/app/ahgoblin/current/tmp/pids/unicorn.pid'
stderr_path '/data/app/ahgoblin/shared/log/unicorn.stderr.log'
stdout_path '/data/app/ahgoblin/shared/log/unicorn.stdout.log'
preload_app true
